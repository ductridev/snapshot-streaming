// scalafmt: { rewrite.scala3.convertToNewSyntax = false, rewrite.scala3.removeOptionalBraces = no }
import sbt._
...
object Dependencies {
  ...
  object Libraries {
    ...
    def catsEffectDefn(artifact: String): ModuleID =
    ...
    val catsEffect = catsEffectDefn("")
    val catsEffectKernel = catsEffectDefn("kernel")
    val catsEffectStd = catsEffectDefn("std")
    val catsEffectTestKit = catsEffectDefn("testkit")
